      ...
      <div className="w-full max-w-md bg-[#18181b] border border-[#27272a] rounded-xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-[#a1a1aa]">Gestão focada em performance</p>
          </div>
          ...
          <p className="mt-8 text-center text-xs text-[#71717a]">
            Para MVP use email <strong className="text-[#a1a1aa]">admin@cfm.com</strong> e senha <strong className="text-[#a1a1aa]">admin</strong>
          </p>
