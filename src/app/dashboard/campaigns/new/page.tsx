        ...
        <div className="bg-zinc-900 border border-zinc-800/60 rounded-xl p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <input id="cid" name="cid" type="text" placeholder="Deixe em branco pro sistema gerar automático" className="w-full bg-zinc-950 border border-zinc-800 text-zinc-100 rounded-md px-4 py-2.5 focus:outline-none text-sm" />
